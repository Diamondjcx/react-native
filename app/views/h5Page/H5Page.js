...
export default class H5Page extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            uri: this.resolveUrl('http://116.62.215.238/index.php?s=/wap'),
            showCurUri: this.resolveUrl('http://116.62.215.238/index.php?s=/wap')
        };
    ...
    componentDidMount() {
        this.handle = BackHandler.addEventListener('hardwareBackPress-H5Page', this.back)
